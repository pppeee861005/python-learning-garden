...
total_characters = len(cambridge_poem)

print(f"\n📊 統計資訊：")
print("-" * 50)
print(f"🔢 新詩行數：{line_count} 行")
print(f"📝 新詩字數：{total_characters} 字（含標點符號）")
...
while True:
    ...
    # 計算搜尋字串出現的次數
    count = poem_lines.count(search_word)
    ...
    if count > 0:
        ...
        print(f"❌  搜尋的字 : 「{search_word}」沒有出現在詩之中 ")
